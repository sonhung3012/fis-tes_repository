package com.addressbook.vaadin.domain;
...
public class Contact implements Serializable {
	...
	public Contact(int id, String familyName, String middleName, String firstName, String groupName, String sentiment,  
		...
		this(familyName, middleName, firstName,
				groupName, sentiment, mobilePhone,
	...
	public String toString() {
		return groupName + " " + sentiment + " " + familyName + " " + middleName + " " + firstName;
	}
